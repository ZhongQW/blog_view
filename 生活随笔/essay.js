            ...
            if(!res.error){
                ...
                for(let j=0;j<res.result.length;j++){
                    ...
                    let str = "        <li class=\"li_\" data-index=\""+ res.result[j].articleId +"\">\n" +
                        "             <i class=\"fa fa-paper-plane\" data-content=\"test\" aria-hidden=\"true\"></i><p onclick=\"handleClick(event)\">"+title+"</p>\n" +
                        "            <div class=\"content_\">\n" +
                        "                <div class=\"img_wrap\">\n" +
                        "                    <img src="+ indexImg +" />\n" +
                        "                </div>\n" +
                    ...
                    document.getElementById('essay_content').getElementsByTagName("li")[j].getElementsByTagName("i")[0].setAttribute ('data-content', iContent);
                    // $("#essay_content").find('img').attr("src",indexImg);
                }
                let oLi = document.getElementById('essay').getElementsByClassName('li_');
